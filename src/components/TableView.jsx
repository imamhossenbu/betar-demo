                ...
                <table className="w-full table-fixed border-collapse border border-gray-700 print:w-full print:min-w-full print:max-w-none">
                    <thead>
                        <tr className="text-sm text-left">
                            <td contentEditable suppressContentEditableWarning className="border border-gray-700 px-2 py-1 w-[25%] whitespace-normal break-words">
                                অফিসার ইনচার্জঃ হাসনাইন ইমতিয়াজ
                            </td>
                            <td contentEditable suppressContentEditableWarning className="border border-gray-700 px-2 py-1 w-[37.5%] whitespace-normal break-words">
